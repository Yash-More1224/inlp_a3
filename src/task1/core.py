...
from src.common.data import PairDataset, build_vocab, chunk_pairs, read_cipher_word_tokens, read_plain_text, read_plain_words, split_indices
...
def _prepare_data(config: dict):
    ...
    return train_ds, val_ds, test_ds, cipher_vocab, word_vocab, plain_text, test_cipher_tokens, test_plain_text
...
def run_task1(config_path: str, mode: str, cell_type: str) -> None:
    ...
    train_ds, val_ds, test_ds, cipher_vocab, word_vocab, plain_text, test_cipher_tokens, test_plain_text = _prepare_data(config)
